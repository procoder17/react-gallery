<p align='center'>
  <img src='https://raw.githubusercontent.com/procoder17/react-sizeme/master/assets/logo.png' width='250'/>
...
## TOCs
 ...
 - [What is this for?](https://github.com/procoder17/react-sizeme#what-is-this-for)
 - [Release Notes](https://github.com/procoder17/react-sizeme#release-notes)
 - [Live Demo](https://github.com/procoder17/react-sizeme#live-demo)
 - [Quick Example](https://github.com/procoder17/react-sizeme#quick-example)
 ...
 - [Things to Consider](https://github.com/procoder17/react-sizeme#things-to-consider)
 - [`react-component-queries`: a useful abstraction](https://github.com/procoder17/react-sizeme#react-component-queries-a-useful-abstraction)
 - [Server Side Rendering](https://github.com/procoder17/react-sizeme#server-side-rendering)
 - [Extreme Appreciation](https://github.com/procoder17/react-sizeme#extreme-appreciation)
...
See here: https://github.com/procoder17/react-sizeme/releases
...
With this in mind I came up with a common abstraction in the form of [`react-component-queries`](https://github.com/procoder17/react-component-queries).  This library allows you to define _query functions_ that will operate on the dimensions provided by `react-sizeme` and when their criteria are met they will pass a custom set of prop(s) to your components. 
